...
| CRUSH-115 | `io.read` capability | **Done 2026-08-23** — implementation and cross-backend/piped-input verification complete; CRUSH-118 remains open for the interactive example. |
