...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-104.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-104`
- Repo: `crush-ast`
- Turns: `60`
- Runner: `claude`
