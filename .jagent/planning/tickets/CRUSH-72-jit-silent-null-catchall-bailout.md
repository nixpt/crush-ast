...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-72.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-72`
- Repo: `crush-ast`
- Turns: `50`
- Runner: `claude`
