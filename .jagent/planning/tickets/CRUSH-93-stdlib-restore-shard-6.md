# CRUSH-93 — STDLIB clean-restore shard 6 of 10 (~10 caps)
...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-93.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-93`
- Repo: `crush-ast`
- Turns: `80`
- Runner: `claude`
