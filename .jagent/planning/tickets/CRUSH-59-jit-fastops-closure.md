...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-59.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-59`
- Repo: `crush-ast`
- Turns: `120`
- Runner: `claude`
