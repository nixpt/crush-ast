# CRUSH-96 — STDLIB clean-restore shard 9 of 10 (~10 caps)
...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-96.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-96`
- Repo: `crush-ast`
- Turns: `80`
- Runner: `claude`
