...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-87.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-87`
- Repo: `crush-ast`
- Turns: `60`
- Runner: `claude`
