# CRUSH-89 — STDLIB clean-restore shard 2 of 10 (~10 caps)
...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-89.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-89`
- Repo: `crush-ast`
- Turns: `80`
- Runner: `claude`
