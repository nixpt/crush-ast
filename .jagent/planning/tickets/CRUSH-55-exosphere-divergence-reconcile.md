...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-55.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-55`
- Repo: `crush-ast`
- Turns: `60`
- Runner: `claude`
