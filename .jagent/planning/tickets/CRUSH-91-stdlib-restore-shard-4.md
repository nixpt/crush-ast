# CRUSH-91 — STDLIB clean-restore shard 4 of 10 (~10 caps)
...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-91.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-91`
- Repo: `crush-ast`
- Turns: `80`
- Runner: `claude`
