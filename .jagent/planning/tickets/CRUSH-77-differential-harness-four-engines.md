...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-77.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-77`
- Repo: `crush-ast`
- Turns: `100`
- Runner: `claude`
