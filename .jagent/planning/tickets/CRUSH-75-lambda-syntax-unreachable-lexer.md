...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-75.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-75`
- Repo: `crush-ast`
- Turns: `80`
- Runner: `claude`
