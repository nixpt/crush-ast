...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-50.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-50`
- Repo: `crush-ast`
- Turns: `60`
- Runner: `claude`
