...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-11.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-11`
- Repo: `crush-ast`
- Turns: `30`
- Runner: `claude`
