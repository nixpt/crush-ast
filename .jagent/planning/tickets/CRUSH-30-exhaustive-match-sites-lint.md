...
Imported from `workspace-meta/prompts/crush-backlog/CRUSH-30.txt` on 2026-08-24 so this tracked ticket contains the dispatch prompt metadata.

- Branch: `agent/horse/CRUSH-30`
- Repo: `crush-ast`
- Turns: `40`
- Runner: `claude`
